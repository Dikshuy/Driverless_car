...
class Sumo_Sim:
    def __init__(self):
        ...
        self.cair_graph = nx.read_graphml('/home/armslab/sumo_ws/src/patrol_algo/graph_ml/CAIR.graphml')
    ...
    def simulation_startup(self, prior_nodes):
        ...
        net = sumolib.net.readNet('/home/armslab/sumo_ws/src/patrol_algo/graph_sumo/CAIR.net.xml')
	    ...
	    '''
            if p_node == '1563324004':
	    	traci.polygon.add(polygonID=str(count), shape=shape_val, color=(255,0,0), fill=True, polygonType='', layer=0, lineWidth=2)
	    else:
		traci.polygon.add(polygonID=str(count), shape=shape_val, color=(0,255,0), fill=True, polygonType='', layer=0, lineWidth=2)
	    '''
	    traci.polygon.add(polygonID=str(count), shape=shape_val, color=(255,0,0), fill=True, polygonType='', layer=0, lineWidth=2)
	    count +=1
