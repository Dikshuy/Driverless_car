        ...
        while traci.simulation.getTime() <= self.min_time:
            ...
            for ith_robot in self.robot_ids:
                ...
                if ith_robot in vehicles:
                    ...
                    last_edge_robot[ith_robot] = last_edge
                    print ("Robot_id....", ith_robot, self.seq_of_routes[ith_robot], last_edge_robot[ith_robot])
                    if last_edge in self.heat_map_key:
                        print ("Last edge: " , str(last_edge), str(last_edge_robot[ith_robot]), str(self.prev_last_edge[ith_robot]), str(last_edge) == str(self.prev_last_edge[ith_robot]))
                    #else:
            ...
            if len(srvs.node_id) > 0:
                ...
                #self.prev_last_edge[srvs.robot_id]  = last_edge_robot[srvs.robot_id]     
